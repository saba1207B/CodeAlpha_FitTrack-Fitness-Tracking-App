...
enum class ExerciseType(
    ...
    WALKING("Walking", 4.5, Icons.Default.DirectionsWalk, Color(0xFF10B981)),
    RUNNING("Running", 10.0, Icons.Default.DirectionsRun, Color(0xFFEF4444)),
    CYCLING("Cycling", 8.0, Icons.Default.DirectionsBike, Color(0xFFF59E0B)),
